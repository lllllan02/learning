...
*   **[首页美化](homepage.md)**：记录了对首页布局、动态组件及视觉样式的深度定制。
*   **[设置字体](fonts.md)**：介绍了如何引入并配置如“霞鹜文楷”等第三方中文字体。
*   **[图片居中与并排](images.md)**：实现了图片的全局自动居中以及多图并排显示的布局。
*   **[图片并排显示](image-row.md)**：记录了通过 `<div class="image-row">` 实现图片横向排版的实现方案。
